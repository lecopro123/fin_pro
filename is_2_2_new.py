...
exp2=a2/b
exp1=a1/b
new_x1 = x1 * (3.5 /3.11)**exp1  #2.8 10k  3.09 1l  3.11 1c
new_x2 = x2 * (3.5 /2.44)**exp2  #2.5 10k  2.45 1l  2.44 1c
...
for i in range(1,n1):   ###looping through the samples
        if new_x1[i]**2 + new_x2[i]**2 >= 3.5:  ####checking acc to the 3rd step of Algo 1
...
for i in range(1,n1):      ###looping through the samples
        #print(x1[i],i)
        if x1[i]**2 + x2[i]**2 >= 3.5:    ####checking acc to the MC approach
                count_mc = count_mc+1
